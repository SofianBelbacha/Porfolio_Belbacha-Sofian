        ...
        <div class="container">
            <div class="row">
                ...
                <div class="list-group list-group-horizontal-lg soft-skills">
                    <div
                        ...
                        <img src="image/idea.png" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Créativité</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="image/outflow.png" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Polyvalent</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="image/adaptation.png" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Adaptation</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="image/social.png" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Esprit d'équipe</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="image/willpower.png" class="mb-2" alt="créatif" style="width: 80px;">
            ...
            <div class="row d-flex no-gutters">
                <div class="col-lg-6 img-none">
                    <div class="img-about" style="background-image: url(https://placehold.co/1000x1074);"></div>
                </div>
                <div class="col-sm-12 col-md-12 col-lg-6 py-5 about-info-section">
                    <div class="about-information ms-lg-5 mx-md-5 mx-sm-2">
                        ...
                        <ul class="about-info mt-4 px-md-0 px-2">
                            ...
                            <li class="d-flex"><span>Tel: </span> <span>+33 7 58 97 96 16</span></li>
                        </ul>
                        <a class="btn btn-danger btn-lg rounded mt-3" onclick="openPDF()">Telecharger mon CV</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-5 col-sm-12">
                    <div class="card me-4 shadow rounded-0">
                        <div class="card-body d-flex flex-column align-items-center text-center">
                            <img src="image/ux-design.png" alt="">
    ...
    <section class="portfolio" id="portfolio">
        <div class="container-fluid">
            ...
            <div class="row mt-5 g-0">
                <div class="col-md-4">
                    <div class="portfolio-work portfolio-img" style="background: url(image/Ap_web.png);">
                        <div class="overlay">
                ...
                <div class="col-md-4">
                    <div class="portfolio-work portfolio-img"
                        style="background: url(image/tentation_voyage-image.png);">
                        <div class="overlay">
                            <div class="text-center-overlay p-4">
                ...
                <div class="col-md-4">
                    <div class="portfolio-work portfolio-img" style="background: url(image/ap_windows.png);">
                        <div class="overlay">
                            <div class="text-center-overlay p-4">
                                <h3>Atelier professionnel du bts sio</h3>
                ...
                <div class="col-md-4">
                    <div class="portfolio-work portfolio-img" style="background: url(image/projet_Deezer.png);"></div>
                </div>
                <div class="col-md-4">
                    <div class="portfolio-work portfolio-img" style="background: url(image/projet_zikboutik.png);"></div>
                </div>
                <div class="col-md-4">
                    <div class="portfolio-work portfolio-img" style="background: url(image/projet_Trott.png);">
                        <div class="overlay">
                            <div class="text-center-overlay p-4">
                                <h3>Site web trotts'insolites</h3>
                                <p>Conception en projet de groupe d'un Site Web  pour une Entreprise de Randonnées en trottinette électrique</p>
                            </div>
                        </div>
                    </div>
                </div>
