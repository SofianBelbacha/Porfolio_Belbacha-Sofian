            ...
            <div class="row">
                ...
                <div class="list-group list-group-horizontal-lg soft-skills">
                    <div
                        ...
                        <img src="<?php echo Chemins::IMAGES . 'idea.png' ?>" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Créatif</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="<?php echo Chemins::IMAGES . 'outflow.png' ?>" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Polyvalent</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="<?php echo Chemins::IMAGES . 'adaptation.png' ?>" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Adaptation</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="<?php echo Chemins::IMAGES . 'social.png' ?>" class="mb-2" alt="créatif" style="width: 80px;">
                        <p style="margin: 0;">Esprit d'équipe</p>
                    </div>
                    <div
                        class="list-group-item list-group-item-action d-flex justify-content-center flex-column align-items-center">
                        <img src="<?php echo Chemins::IMAGES . 'willpower.png' ?>" class="mb-2" alt="créatif" style="width: 80px;">
